    ...
    <>
      ...
      <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 antialiased">
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
          <div class=" dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
              ...
              <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                ...
                <div class="flex items-center space-x-3 w-full md:w-auto">
                  <button
                    ...
                    class="w-full md:w-auto flex items-center justify-center py-2 px-4 text-sm font-medium text-gray-900 focus:outline-none  rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                    type="button"
                  >
                    <svg
                  ...
                  <div
                    id="actionsDropdown"
                    class="hidden z-10 w-44  rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"
                  >
                    <ul
                  ...
                  <div
                    id="filterDropdown"
                    class="z-10 hidden w-56 p-3  rounded-lg shadow dark:bg-gray-700"
                  >
            ...
            >
              <span class="text-sm font-normal text-gray-500 dark:text-gray-400" style={{display: 'flex', gap: '0.5rem'}}>
                Showing
      ...
      >
        <div class="relative p-4 w-full max-w-2xl max-h-full">
          <div class="relative p-4  rounded-lg shadow dark:bg-gray-800 sm:p-5">
          ...
          <div class="relative p-4  rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-between items-center">
              <div class="flex items-center space-x-3 sm:space-x-4">
                ...
                <button
                  type="button"
                  class="py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none  rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                >
                  Preview
                </button>
              </div>
      ...
      >
        <div class="relative p-4 w-full max-w-md max-h-full">
          <div class="relative p-4 text-center  rounded-lg shadow dark:bg-gray-800 sm:p-5">
            <button
              type="button"
