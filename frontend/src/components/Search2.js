...
const Search2 = () => {
  ...
  const fetchData = async () => {
    ...
    //   const response = await axios.get("http://20.236.136.145:53001/getAllData");
      const response = await axios.get("http://20.236.136.145:53001/combinedData");
  ...
  const filterHandler = (e) => {
    const filterData = result?.filter((item) => {
      ...
      if(e?.target?.value ){
       if(e.target.value == 'ldn20'){
        //console.log(item)
       }
       if(e.target.value == 'ldn40'){
        //console.log(e.target.value)
       }
       if(e.target.value == 'isotank'){
        //console.log(e.target.value)
       }
       if(e.target.value == 'mt20'){
        //console.log(e.target.value)
       }
       if(e.target.value == 'mt40'){
        //console.log(e.target.value)
       }
       if(e.target.value == 'isotankmt'){
        //console.log(e.target.value)
       }
      }
      return true;
